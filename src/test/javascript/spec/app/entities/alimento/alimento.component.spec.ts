...
import { AlimentoComponent } from 'app/entities/alimento/alimento.component';
  ...
  describe('Alimento Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AlimentoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alimentos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
