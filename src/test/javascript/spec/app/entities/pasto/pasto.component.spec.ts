...
import { PastoComponent } from 'app/entities/pasto/pasto.component';
import { PastoService } from 'app/entities/pasto/pasto.service';
import { Pasto } from 'app/shared/model/pasto.model';

describe('Component Tests', () => {
  describe('Pasto Management Component', () => {
    let comp: PastoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PastoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pastos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
