package it.aguzzo.diarioalimentare.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, it.aguzzo.diarioalimentare.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.aguzzo.diarioalimentare.repository.UserRepository.USERS_BY_EMAIL_CACHE);
